...
while game.check_for_winner()==-1:
    ...
    print_board()
    print("My turn.")
    listAvailMoves = game.get_open_spots()
    randomMove = choice(listAvailMoves)
    randomMove_r = randomMove[0]
    randomMove_c = randomMove[1]
    game.make_move(randomMove_r, randomMove_c)
